...
export class AddGenericEndpointsDialog extends AddServiceEndpointDialog {
    ...
    public getTitle(): string {
        var title = AdminResources.AddGenericConnectionsDialogTitle;
    ...
    protected getServiceEndpointDetails(): AdminCommon.ServiceEndpointDetails {
        ...
        var username = this._element.find("#username").val().trim();

        var passwordKey = this._element.find("#pwd").val().trim();
        ...
        var apiData: AdminCommon.IServiceEndpointApiData = {
            ...
            type: TFS_Admin_Common.ServiceEndpointType.Generic,
...
VSS.tfsModuleLoaded("TFS.Admin.Controls.GenericEndpointsManageDialog", exports);
