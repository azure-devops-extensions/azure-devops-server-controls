...
export interface IFormattedComponentProps extends React.HTMLProps<HTMLElement> {
 ...
 */
export const FormattedComponent: React.StatelessComponent<IFormattedComponentProps> =
    (props: IFormattedComponentProps): JSX.Element => {
