 ...
 */
export class ShowDeletePermissionsDialogHandler {
    public static handle(state: IFeedSettingsState, emitCallback: () => void, onSaveCallback: () => void): void {
        state.dialogProps = {
            headerText: PackageResources.GeneralDialog_PermissionDelete_Header,
            confirmText: PackageResources.GeneralDialog_PermissionDelete_Content,
            ...
            onSaveCallback: async () => {
                CustomerIntelligenceHelper.publishEvent(FeedSettingsCi.ShowDeletePermissionsDialog, {
