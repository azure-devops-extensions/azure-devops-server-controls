...
import { PostDeploymentConditionView } from "PipelineWorkflow/Scripts/Editor/Environment/PostDeploymentConditionControllerView";
...
export class PostDeploymentApprovalsItem implements Item {
    ...
    constructor(private _releaseDefinitionFolderPath: string, private _releaseDefinitionId, private _environmentId, private _environmentName: string, private _instanceId: string, private _isReleaseView: boolean = false) {
    }
