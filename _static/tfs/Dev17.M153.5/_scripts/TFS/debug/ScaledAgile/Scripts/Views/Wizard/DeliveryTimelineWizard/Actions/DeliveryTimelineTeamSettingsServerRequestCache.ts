/**
 * Interface for DeliveryTimelineWizardServerRequestCache.
 */
export interface IDeliveryTimelineTeamSettingsServerRequestCache {
    /**
...
/**
 * This class acts as cache storing lastest delivery timeline wizard server request.
 */
export class DeliveryTimelineTeamSettingsServerRequestCache implements IDeliveryTimelineTeamSettingsServerRequestCache {
