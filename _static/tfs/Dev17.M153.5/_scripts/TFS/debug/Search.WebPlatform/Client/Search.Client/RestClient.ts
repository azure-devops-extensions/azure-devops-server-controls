...
import Contracts = require("Search.Client/Contracts");
 ...
 *
 * @return SearchHttpClient5
 */
export function getClient(options?: VSS_WebApi.IVssHttpClientOptions): SearchHttpClient5 {
    if ((<any>window).VSS && (<any>window).VSS.VssSDKRestVersion && clientMapping[(<any>window).VSS.VssSDKRestVersion]) {
        return VSS_Service.getClient<SearchHttpClient5>(<any>(clientMapping[(<any>window).VSS.VssSDKRestVersion]), undefined, undefined, undefined, options);
    }
    else {
        return VSS_Service.getClient<SearchHttpClient5>(SearchHttpClient5, undefined, undefined, undefined, options);
    }
}
