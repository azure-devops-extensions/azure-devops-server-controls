...
import { css, IRenderFunction, autobind } from "OfficeFabric/Utilities";
...
export class CollapsiblePanel extends React.Component<ICollapsiblePanelProps, ICollapsiblePanelState> {
    ...
    private _onToggle = () => { this._toggle(); };
    ...
    public render(): JSX.Element {
        ...
        if (shouldRenderContent && !this._content) {
            this._content = this.props.renderContent();
        }

        return <div className={css("grid-group-container", this.props.className)}>
            <div className="grid-group">
                ...
                {this.props.animate ?
                    ...
                    : this._content != null ? this._renderContent() : null
                }
            </div>
        </div>;
    }
    ...
    protected _renderContent(): JSX.Element {
        ...
        return <div className="tfs-collapsible-content" style={style}>
            {this._content}
        </div>;
    }
    ...
    protected _renderHeader(): JSX.Element {
        ...
        return <div role="heading" aria-level={2}>
            <button
                ...
                <span className={toggleClasses} style={{
                    "display": !this.props.isCollapsible ? "none" : null
                }}></span>
                <span className="tfs-collapsible-text">
                    {onRenderHeader(headerLabel, this._renderHeaderLabel)}
                </span>
            </button>
        </div>;
    }
